# Graph Report - /Users/shagwu/Downloads/Road4AI-main  (2026-04-26)

## Corpus Check
- 79 files · ~411,130 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 369 nodes · 442 edges · 72 communities detected
...
1. `MemoryBridge` - 9 edges
2. `main()` - 7 edges
3. `parse_args()` - 7 edges
4. `_preset_path()` - 6 edges
5. `remove_mcp()` - 6 edges
6. `ollama_chat()` - 5 edges
7. `_load_ledger()` - 5 edges
8. `_lookup_cost()` - 5 edges
9. `cmd_log()` - 5 edges
10. `load_settings()` - 5 edges
...
- `parse_args()` --calls--> `main()`  [INFERRED]
  /Users/shagwu/Downloads/Road4AI-main/verify_repo.py → /Users/shagwu/Downloads/Road4AI-main/banana-claude/skills/banana/scripts/generate.py
- `parse_args()` --calls--> `main()`  [INFERRED]
  /Users/shagwu/Downloads/Road4AI-main/verify_repo.py → /Users/shagwu/Downloads/Road4AI-main/banana-claude/skills/banana/scripts/batch.py
...
- **Why does `cmd_list()` connect `Community 1` to `Community 0`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `parse_args()` connect `Community 0` to `Community 2`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `_lookup_cost()` connect `Community 3` to `Community 0`?**
