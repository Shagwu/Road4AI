# Graph Report - /Users/shagwu/Downloads/Road4AI-main  (2026-06-18)

## Corpus Check
- 114 files · ~592,235 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 683 nodes · 1032 edges · 105 communities detected
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 184 edges (avg confidence: 0.76)
...
3. `BenchmarkRunner` - 28 edges
4. `parse_args()` - 12 edges
5. `LLMCapture` - 11 edges
6. `HermesStorage` - 11 edges
7. `SkillOptClient` - 10 edges
8. `make_repo()` - 10 edges
9. `MemoryBridge` - 9 edges
10. `SelfIndexer` - 9 edges
...
Cohesion: 0.06
Nodes (36): BaseKnowledgeStorage, MemoryBridgeV2, Record a user<->AI conversation as a memory.          Parameters:         - user, Best-effort persistence/flush for underlying Chroma client if supported., load_queue(), main(), read_task(), HermesStorage (+28 more)

### Community 1 - "Community 1"
Cohesion: 0.11
Nodes (13): BenchmarkRunner, main(), UsageSnapshot, make_repo(), test_baseline_only_skips_optimizer_and_writes_case_scores(), test_dry_run_writes_validation_report(), test_live_mode_requires_usage_output(), test_non_skill_markdown_is_rejected() (+5 more)

### Community 2 - "Community 2"
Cohesion: 0.11
Nodes (11): LLMCapture, Lightweight LLM wrapper that optionally captures conversations to Hermes v2 brid, Run a chat completion and optionally capture the conversation to Hermes bridge., demo(), example_initialize_bridge(), HermesMemoryTool, Example adapter showing how to adapt a Memori-based social media agent to use He, MemoryBridge (+3 more)
...
Cohesion: 0.18
Nodes (16): Finding, iter_markdown(), line_number(), main(), sanitize_file(), sanitize_text(), scan_file(), scan_text() (+8 more)
...
Cohesion: 0.3
Nodes (13): build_sync_items(), check_items(), dirs_equal(), load_manifest(), main(), protected_runtime_locations(), sync_item(), SyncItem (+5 more)
...
Cohesion: 0.34
Nodes (12): append_run(), build_run_entry(), gemini_version(), git_commit(), main(), read_json(), write_json(), stability_seed() (+4 more)
...
Cohesion: 0.2
Nodes (8): Initialize the agent engine app with logging and telemetry., Collect and log feedback., Registers the operations of the Agent., BaseModel, collect_feedback(), Collect and log feedback.      Args:         feedback: The feedback data to log, Feedback, Represents feedback for a conversation.
...
Cohesion: 0.53
Nodes (5): main(), main_menu(), print_header(), # TODO: Replace this stub with real agent / model calls., run_research_outline()
...
Cohesion: 1.0
Nodes (1): Searches for code in GitHub repositories.          Args:         query: The sear

### Community 89 - "Community 89"
Cohesion: 1.0
Nodes (1): Gets recent commits for a repository or a specific file.          Args:

### Community 90 - "Community 90"
Cohesion: 1.0
Nodes (1): Reads the content of a file from GitHub.          Args:         repo: Repository

### Community 91 - "Community 91"
Cohesion: 1.0
Nodes (1): Fixture to create and set up AgentEngineApp instance

### Community 92 - "Community 92"
Cohesion: 1.0
Nodes (1): Integration test for the agent stream query functionality.     Tests that the ag

### Community 93 - "Community 93"
Cohesion: 1.0
Nodes (1): Integration test for the agent feedback functionality.     Tests that feedback c
...
## Knowledge Gaps
- **77 isolated node(s):** `Call the local Ollama /api/generate endpoint.     Uses only stdlib (urllib) — no`, `Warn early if Ollama isn't reachable or the model isn't pulled.`, `Get the staged git diff. Returns None if nothing is staged.`, `Send the diff to the local adversary model. Returns raw accusations.`, `Apply Karen's 8-step filter to the adversary's accusations.` (+72 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 85`** (2 nodes): `get_status()`, `road4ai_v3.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (1 nodes): `Searches for code in GitHub repositories.          Args:         query: The sear`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (1 nodes): `Gets recent commits for a repository or a specific file.          Args:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (1 nodes): `Reads the content of a file from GitHub.          Args:         repo: Repository`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (1 nodes): `Fixture to create and set up AgentEngineApp instance`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (1 nodes): `Integration test for the agent stream query functionality.     Tests that the ag`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (1 nodes): `Integration test for the agent feedback functionality.     Tests that feedback c`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (1 nodes): `HermesStorage is the integration bridge. It inherits from CrewAI's BaseKnowledge`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 95`** (1 nodes): `Saves a chunk of knowledge to the Hermes v2.0 substrate.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (1 nodes): `Retrieves relevant context from the Hermes v2.0 substrate.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 97`** (1 nodes): `Deletes specific entries from the substrate.         Note: Hermes V2 wrapper for`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 98`** (1 nodes): `Resets the entire collection. DANGEROUS: use with caution.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 99`** (1 nodes): `Call the local Ollama /api/generate endpoint.     Uses only stdlib (urllib) — no`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 100`** (1 nodes): `Warn early if Ollama isn't reachable or the model isn't pulled.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 101`** (1 nodes): `Get the staged git diff. Returns None if nothing is staged.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 102`** (1 nodes): `Send the diff to the local adversary model. Returns raw accusations.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (1 nodes): `Apply Karen's 8-step filter to the adversary's accusations.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (1 nodes): `Post Karen's verdict as a comment on the current open PR via GitHub CLI.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `MemoryBridgeV2` connect `Community 0` to `Community 2`, `Community 4`, `Community 14`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `parse_args()` connect `Community 7` to `Community 1`, `Community 3`, `Community 4`, `Community 6`, `Community 10`, `Community 12`?**
...
- **Are the 11 inferred relationships involving `parse_args()` (e.g. with `main()` and `main()`) actually correct?**
  _`parse_args()` has 11 INFERRED edges - model-reasoned connections that need verification._
