...
The [v2.1.0 release](https://github.com/Shagwu/Road4AI/releases/tag/v2.1.0) (two weeks ago) was the foundation: skills with governance baked in from the start. Orchestration rules locked into AGENTS.md. Drift thresholds defined. Confidence tiering enforced. Karen (adversarial reviewer) gates everything.
