...
- [We Tested SkillOpt Locally Before Letting Hermes Learn](https://shagwu.github.io/Road4AI/blog-skillopt-validation.html) — how we validated SkillOpt's three-model benchmark runner and governance boundary before wiring it into Hermes v2.1.

## Links

- Landing page: [shagwu.github.io/Road4AI](https://shagwu.github.io/Road4AI/)
- Blog: [SkillOpt validation post](https://shagwu.github.io/Road4AI/blog-skillopt-validation.html)
